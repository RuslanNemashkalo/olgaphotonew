...
class WpdiscuzOptionsSerialized {
    ...
    public function initPhrases() {
        $this->phrases = array(
            'wc_be_the_first_text' => __('Будьте первым комментатором!', 'wpdiscuz'),
            'wc_header_text' => __('Комментарий', 'wpdiscuz'),
            'wc_header_text_plural' => __('Коментарии', 'wpdiscuz'), // PLURAL
            'wc_header_on_text' => __('на', 'wpdiscuz'),
            'wc_comment_start_text' => __('Начать обсуждение', 'wpdiscuz'),
            'wc_comment_join_text' => __('Присоединяйтесь к обсуждению', 'wpdiscuz'),
            'wc_email_text' => __('Email', 'wpdiscuz'),
            'wc_notify_of' => __('Уведомить о', 'wpdiscuz'),
            'wc_notify_on_new_comment' => __('новых последующих комментариев', 'wpdiscuz'),
            'wc_notify_on_all_new_reply' => __('новых ответах на мои комментарии', 'wpdiscuz'),
            'wc_notify_on_new_reply' => __('Сообщать о новых ответах на этот комментарий', 'wpdiscuz'),
            'wc_sort_by' => __('Сортировать', 'wpdiscuz'),
            'wc_newest' => __('новые', 'wpdiscuz'),
            'wc_oldest' => __('более старые', 'wpdiscuz'),
            'wc_most_voted' => __('популярные', 'wpdiscuz'),
            'wc_load_more_submit_text' => __('Загрузить подробнее комментарии', 'wpdiscuz'),
            'wc_load_rest_comments_submit_text' => __('Остальные загрузки комментарии', 'wpdiscuz'),
            'wc_reply_text' => __('Ответить', 'wpdiscuz'),
            'wc_share_text' => __('Поделиться', 'wpdiscuz'),
            'wc_edit_text' => __('Редактировать', 'wpdiscuz'),
            'wc_share_facebook' => __('Поделиться в Facebook', 'wpdiscuz'),
            'wc_share_twitter' => __('Поделиться в Twitter', 'wpdiscuz'),
            'wc_share_google' => __('Поделиться в Google', 'wpdiscuz'),
            'wc_share_vk' => __('Поделиться в Вконтакте', 'wpdiscuz'),
            'wc_share_ok' => __('Поделиться в Однокласники', 'wpdiscuz'),
            'wc_hide_replies_text' => __('Скрыть ответы', 'wpdiscuz'),
            'wc_show_replies_text' => __('Показать ответы', 'wpdiscuz'),
            'wc_email_subject' => __('Новый коментарий', 'wpdiscuz'),
            'wc_email_message' => __('Новый комментарий в разделе обсуждения того как вы были заинтересованы в', 'wpdiscuz'),
            'wc_new_reply_email_subject' => __('Новый ответ', 'wpdiscuz'),
            'wc_new_reply_email_message' => __('Новый ответ на раздел обсуждения того как вы были заинтересованы в', 'wpdiscuz'),
            'wc_subscribed_on_comment' => __('Вы подписаны на новые ответы на этот комментарий', 'wpdiscuz'),
